package com.dyh.club.subject.application.controller;

import com.alibaba.fastjson.JSON;
import com.google.common.base.Preconditions;
import com.dyh.club.subject.application.convert.SubjectAnswerDTOConverter;
import com.dyh.club.subject.application.convert.SubjectInfoDTOConverter;
import com.dyh.club.subject.application.dto.SubjectInfoDTO;
import com.dyh.club.subject.common.entity.PageResult;
import com.dyh.club.subject.common.entity.Result;
...
public class SubjectController {
    ...
    public Result<Boolean> add(@RequestBody SubjectInfoDTO subjectInfoDTO) {
        try {
            ...
            subjectInfoBO.setOptionList(subjectAnswerBOS);// @2
    ...
    public Result<Boolean> pushMessage(@Param("id") int id) {
        rocketMQTemplate.convertAndSend("test-topic", "DYH Club早上好" + id);
        return Result.ok(true);
    }
